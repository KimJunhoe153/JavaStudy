...
select
	...
	23 * 5,
	23 / 5,
	23 div 5,-- div는 나누기랑 같지만 정수값만 표시한다. 정수형 나누기.
	23 % 5,
	23 mod 5;
...
select
	...
	23 != 23,
	23 <> 23; -- <> 같지않다. (!=와 같은 의미)
-- 0과 1로만 값을 나타낸다 0은 false, 1은 true.
...
select * from 고객
where 고객번호 like '_C%'; -- '_'은 정확히 한 개의 문자를 의미, 두번째 자리가 'C'인 문자열을 의미함

select * from 고객
where 도시 like '__C%'; -- 3번째 문자가 'C'
